...
/**
 * Adapter for the horizontal suggestion cards shown inline in the home feed.
 * Each card shows a user's profile picture, username, full name, and a Follow button.
 */
class SuggestionCardAdapter(
    private val onFollowClick: (String) -> Unit,
    private val onDismissClick: (String) -> Unit,
    private val onProfileClick: (String) -> Unit
) : ListAdapter<User, SuggestionCardAdapter.CardViewHolder>(UserDiffCallback()) {
